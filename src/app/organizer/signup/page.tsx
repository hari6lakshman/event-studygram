    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-10rem)] py-12">
      <Card className="w-full max-w-md border-4 border-primary">
        <CardHeader>
          ...
          <CardDescription>Create an account to start posting your events.</CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex flex-col gap-4">
          <Button className="w-full" disabled>Create Account</Button>
           <p className="text-xs text-center text-muted-foreground">
            Sign up is disabled for this prototype. Please use the pre-existing login credentials.
          </p>
